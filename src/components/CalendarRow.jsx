...
export default function CalendarRow({
    ...
    if (!row) {
        ...
        content.push(
            <td key={currentMonth + "_" + 1} className="relative py-3 px-2 md:px-3  hover:text-blue-500 text-center text-gray-800">
                1
            </td>
        );
            ...
            content.push(
                <>
                    {activeDay === i + 1 &&
                        ...
                        <td key={currentMonth + "_" + i} className="relative py-3 px-2 md:px-3  hover:text-blue-500 text-center text-gray-800">
